...
Revision ID: 2ba7fc1cc9e9
Revises: 
Create Date: 2020-05-03 03:53:36.700661
...
def upgrade():
    ...
    sa.Column('seeking_venues', sa.String(length=120), nullable=False),
    sa.Column('website_link', sa.String(length=120), nullable=False),
    sa.Column('seeking_artists', sa.String(length=120), nullable=False),
    sa.Column('genres', sa.ARRAY(sa.Integer()), nullable=False),
